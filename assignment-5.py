##sum of positive numbers number 1
...
##find the square of each element number 4
def sum_of_positives(numbers):
    return sum(num for num in numbers if num > 0)
...
##sort alphabetically number 7
def sort_strings(strings):
    return sorted(strings)

# Example usage:
words = ["banana", "apple", "cherry", "date"]
print("Sorted list:", sort_strings(words))

##list intersection number 8
...
def main():
    while True:
        ...
        print("9. Sort a list of strings alphabetically")
        ...
        if choice == "1":
            ...
            print("Sorted list:", sort_strings(strings))
        elif choice == "10":
